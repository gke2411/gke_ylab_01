...
class New_design20240901211304 extends Version
{
  ...
  'CODE' => 'products_new_design',
  'API_CODE' => NULL,
  'REST_ON' => 'N',
  'NAME' => 'Новые изделия',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/new_design/index.php',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/new_design/detail.php?ID=#ELEMENT_ID#',
  ...
  'HINT' => '',
    ...
    {
        $helper = $this->getHelperManager();
        $ok = $helper->Iblock()->deleteIblockIfExists('products_new_design');
